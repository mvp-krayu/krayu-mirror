---
layout: base.njk
title: "Execution Stability Index (ESI) — Program Intelligence"
description: "The Execution Stability Index (ESI) is a composite structural stability indicator that converts multi-dimensional execution signals into a single measure of whether a program is stable, degrading, or approaching systemic risk."
...
[Risk Acceleration Gradient — full explanation →](/risk-acceleration-gradient)
...
**Period:** 6-Sprint Execution Stability Snapshot
**ESI movement:** 68 → 42 (−26 points over 6 sprints)
**Final band:** Critical Exposure
...
ESI is directly comparable across programs of different size, structure, and delivery approach — because it normalizes across a consistent signal framework. This comparability makes it the primary analytical construct for [Portfolio Intelligence](/portfolio-intelligence): structured comparison of execution stability across the organization's delivery landscape.
