---
layout: base.njk
title: "Signal Infrastructure — Program Intelligence"
description: "Signal Infrastructure is the governed system through which Program Intelligence converts execution evidence from engineering systems into structured analytical outputs — ESI, RAG, and ExecLens intelligence — with every output linked to verifiable source artifacts."
canonical: "https://krayu.be/program-intelligence#signal-infrastructure"
publish_status: "live"
---
...
- [Execution Stability Index (ESI)](/execution-stability-index) — composite structural stability measure
- [Risk Acceleration Gradient (RAG)](/risk-acceleration-gradient) — rate of change of execution instability
...
Signal Infrastructure is the system that resolves [Execution Blindness](/execution-blindness). Execution Blindness exists because the interpretive layer between operational evidence and structural intelligence was absent.
